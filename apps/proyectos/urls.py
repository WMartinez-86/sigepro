...
admin.autodiscover()
from views import lista_proyectos, registra_proyecto, RegisterSuccessView, editar_proyecto, buscar_proyecto, cambiar_estado_proyecto, detalle_proyecto, estadoKanban
...
urlpatterns = patterns('',
        ...
        url(r'^kanban/(?P<id_proyecto>\d+)$', estadoKanban, name='estadoKanban'),
