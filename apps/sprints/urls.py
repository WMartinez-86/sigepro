...
admin.autodiscover()
from views import listar_sprints, registrar_sprint, eliminar_sprint, buscar_sprints, iniciar_sprint, finalizar_sprint, listar_USSprintBacklog, graficar
from views import asignar_userStorySprint
